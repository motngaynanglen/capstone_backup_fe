...
export const submitQuote = async (id, payload) => {
  // payload: { quotedPrice, currency, staffNote, laborCost?, components?, previewGlbUrl?, designFileUrls? }
...
// Lưu ý: DesignWorkId truyền qua URL path, không cần (và không có) trong body.
