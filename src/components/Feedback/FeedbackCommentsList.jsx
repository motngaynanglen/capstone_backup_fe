          ...
          {items.map((fb) => (
            <div key={fb.id} className="space-y-2">
              ...
              <div className="flex justify-start pl-10">
                <div className="max-w-[90%] rounded-2xl rounded-tl-sm bg-gray-100 px-4 py-3">
                  {fb.comment ? (
              ...
              {fb.staffReply && (
                <div className="flex justify-end pl-10">
                  <div className="max-w-[90%] rounded-2xl rounded-tr-sm bg-indigo-600 text-white px-4 py-3">
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-indigo-200 m-0 mb-1">
                      Phản hồi cửa hàng
                    </p>
                    <p className="text-sm whitespace-pre-wrap m-0">{fb.staffReply}</p>
                  </div>
                </div>
              )}
            </div>
