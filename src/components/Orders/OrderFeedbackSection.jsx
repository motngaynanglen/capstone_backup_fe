            ...
            <div key={item.id} className="space-y-2">
              ...
              <div className="flex justify-start">
                <div className="max-w-[85%] rounded-2xl rounded-tl-sm bg-gray-100 px-4 py-3">
                  ...
                  {fb.comment && <p className="text-sm text-gray-800 whitespace-pre-wrap">{fb.comment}</p>}
              ...
              {fb.staffReply && (
                <div className="flex justify-end">
                  <div className="max-w-[85%] rounded-2xl rounded-tr-sm bg-indigo-600 text-white px-4 py-3">
                    <p className="text-[10px] font-semibold uppercase tracking-wide text-indigo-200 mb-1">Phản hồi cửa hàng</p>
                    <p className="text-sm whitespace-pre-wrap">{fb.staffReply}</p>
                  </div>
                </div>
              )}
            </div>
